...
Custom triggers are a way for external systems to manually trigger Engage to start an automation. You can set up custom triggers yourself in [<u>the Engage configuration area</u>](https://developer.voyado.com/en/configure-engage/custom-triggers.html).
