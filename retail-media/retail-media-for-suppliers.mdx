...
![Nexta Campaign View Pn](/images/nexta_campaign_view.png)

## Creating a new campaign 

Click **“+ New campaign”** in the top-left  to begin creating a new campaign. You can choose to target either a **category** or \*\*specific products \*\*(if enabled): 
...
![Mceclip3 Pn](/images/mceclip3.png)

- **Specific products:** _Are subject to enablement per retail environment._ Toggle “Manual selection” to handpick specific products from your feed. You can choose products across categories. Use “Show selected only” to focus your view on the selected items.

  ![Mceclip1(1) Pn](/images/mceclip1\(1\).png)
...
![Nexta Create Campaign 2 Pn](/images/nexta_create_campaign_2.png)
